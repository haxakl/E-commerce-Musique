 ...
 * @author julien
 */
@WebServlet(name = "Instruments", urlPatterns = {"/instruments/*"})
public class Instruments extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        this.getServletContext().getRequestDispatcher("/view/frontoffice/instruments.jsp").forward(request, response);
    }
